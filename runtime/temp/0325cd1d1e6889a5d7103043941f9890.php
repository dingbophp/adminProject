                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('module'); ?></th>
                            <th><?php echo \think\Lang::get('level'); ?><?php echo table_sort('level'); ?></th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $vo['module_turn']; ?></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="level" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['level']; ?></span></td>
