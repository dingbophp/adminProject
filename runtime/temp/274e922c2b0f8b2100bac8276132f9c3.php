<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:101:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\arctype\index.html";i:1518166002;s:99:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\base.html";i:1518166002;s:107:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\admin_load_t.html";i:1518166002;s:104:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\admin_top.html";i:1518166002;s:105:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\admin_left.html";i:1518166002;s:106:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\list_action.html";i:1518166002;s:107:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\admin_bottom.html";i:1518166002;s:107:"D:\phpstudy_pro\WWW\tp5\Tp5-TuFanInc-Admin-master\public/../application/admin\view\public\admin_load_b.html";i:1518166002;}*/ ?>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('typename'); ?></th>
                            <th><?php echo \think\Lang::get('mid'); ?></th>
                            <th><?php echo \think\Lang::get('dirs'); ?></th>
                            <th><?php echo \think\Lang::get('status'); ?></th>
                            <th><?php echo \think\Lang::get('sorts'); ?></th>
                            <th width="258"><?php echo \think\Lang::get('action'); ?></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($vo['h_layer'] == 1): else: $__FOR_START_3633__=1;$__FOR_END_3633__=$vo['h_layer'];for($i=$__FOR_START_3633__;$i < $__FOR_END_3633__;$i+=1){ ?>　　　<?php } ?>├
                                <?php endif; ?>
                                <span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="typename" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['typename']; ?></span>
                            </td>
                            <td><?php echo $vo['ArctypeMod']->name; ?></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="dirs" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['dirs']; ?></span></td>
                            <td>
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="<?php echo $vo['typelink']; ?>" target="_blank"><i class="fa fa-eye"></i> <?php echo \think\Lang::get('preview'); ?></a>
                                <?php if($vo['mid'] == 20 || $vo['mid'] == 22): ?>
                                <button class="btn btn-default btn-xs disabled"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('create_arc'); ?></button>
                                <?php else: ?>
                                <?php echo authAction('Archive/create', 'create_arc', ['typeid' => $vo['id']]); endif; ?>
